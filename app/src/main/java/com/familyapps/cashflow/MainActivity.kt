...
class MainActivity : AppCompatActivity() {
    ...
    private fun createCardList() {
        cardSummaryList.add(CardSummaryStatement(R.drawable.ic_android, "$4,440.00", "American Express Platinum"))
        cardSummaryList.add(CardSummaryStatement(R.drawable.ic_event_seat, "$4,780.00", cardName = "Banamex Oro"))
        cardSummaryList.add(CardSummaryStatement(R.drawable.ic_flight_land, "$130.00", cardName = "Volaris 2.0"))
    }
    ...
    fun addCard(view: View) {
        cardSummaryList.add(CardSummaryStatement(R.drawable.ic_flight_land, "$6,780.00", "Banncomer Azul"))
